...
export const DEMO_CLIENTES = [
  { id: 'c1', nome: 'Carlos Silva',   telefone: '(11) 99999-1111', email: 'carlos@email.com', placa: 'ABC-1234', modelo_veiculo: 'Chevrolet Onix',   cor: 'Prata',    pontos: 320, nivel: 'ouro',     total_atendimentos: 18, total_gasto: 1080, ultima_visita: new Date(Date.now() - 2 * 86400000).toISOString(), created_at: new Date(Date.now() - 180 * 86400000).toISOString() },
  { id: 'c2', nome: 'Ana Souza',      telefone: '(11) 99999-2222', email: 'ana@email.com',    placa: 'DEF-5678', modelo_veiculo: 'Hyundai HB20',     cor: 'Branco',   pontos: 150, nivel: 'prata',    total_atendimentos: 9,  total_gasto:  540, ultima_visita: new Date(Date.now() - 5 * 86400000).toISOString(), created_at: new Date(Date.now() - 90  * 86400000).toISOString() },
  { id: 'c3', nome: 'Roberto Nunes',  telefone: '(11) 99999-3333', email: null,               placa: 'GHI-9012', modelo_veiculo: 'Volkswagen Gol',   cor: 'Vermelho', pontos: 80,  nivel: 'bronze',   total_atendimentos: 5,  total_gasto:  300, ultima_visita: new Date(Date.now() - 1 * 86400000).toISOString(), created_at: new Date(Date.now() - 60  * 86400000).toISOString() },
  { id: 'c4', nome: 'Fernanda Lima',  telefone: '(11) 99999-4444', email: 'fe@email.com',     placa: 'JKL-3456', modelo_veiculo: 'Toyota Corolla',   cor: 'Preto',    pontos: 520, nivel: 'diamante', total_atendimentos: 32, total_gasto: 1920, ultima_visita: new Date(Date.now() - 0 * 86400000).toISOString(), created_at: new Date(Date.now() - 365 * 86400000).toISOString() },
  { id: 'c5', nome: 'Marcos Andrade', telefone: '(11) 99999-5555', email: null,               placa: 'MNO-7890', modelo_veiculo: 'Ford Ka',          cor: 'Azul',     pontos: 40,  nivel: 'bronze',   total_atendimentos: 3,  total_gasto:  180, ultima_visita: new Date(Date.now() - 7 * 86400000).toISOString(), created_at: new Date(Date.now() - 30  * 86400000).toISOString() },
  { id: 'c6', nome: 'Juliana Costa',  telefone: '(11) 99999-6666', email: 'ju@email.com',     placa: 'PQR-1122', modelo_veiculo: 'Honda Civic',      cor: 'Cinza',    pontos: 200, nivel: 'prata',    total_atendimentos: 12, total_gasto:  720, ultima_visita: new Date(Date.now() - 3 * 86400000).toISOString(), created_at: new Date(Date.now() - 120 * 86400000).toISOString() },
]
